...
Alyssa = User("Alyssa Jones", "alyssajones@codingdojo.com")
...
Alyssa.make_deposit(100).make_deposit(200).make_deposit(300).make_withdrawal(500).display_user_balance()
...
Michael.make_deposit(500).make_deposit(100).make_withdrawal(200).make_withdrawal(100).display_user_balance()
...
Kobe.make_deposit(800).make_withdrawal(200).make_withdrawal(400).make_withdrawal(200).display_user_balance()